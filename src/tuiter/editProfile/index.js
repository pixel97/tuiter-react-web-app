...
const EditProfile = () => {
  ...
  let [initProfile, setProfile] = useState(profile);
  const dispatch = useDispatch();
  const saveClickHandler = () => {
    dispatch({ type: "modify-profile", profile: initProfile });
  };
  return (
    <>
      <div className="row">
        <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2">
          <Link to="/tuiter/profile">
            <IconButton children={<CloseIcon />} style={{ color: "white" }} />
          </Link>
        </div>
        ...
        <div className="col-xxl-2 col-xl-2 col-lg-2 col-md-2 col-sm-2 mt-1">
          <div
            className="btn wd-rounded-buttons"
            style={{ background: "white" }}
            onClick={() => {
              saveClickHandler();
              console.log("test");
              <NavLink to="/tuiter/profile"></NavLink>;
            }}
          >
      ...
      <img
        ...
        className="wd-rounded-images position-relative"
        height="100px"
        width="100px"
        style={{ bottom: "1rem" }}
      />
      <form>
        <div className="form-group">
          <label for="name" className="wd-gray-color">
            First Name
          </label>
          <input
            type="text"
        ...
        <div className="form-group">
          <label htmlFor="name" className="wd-gray-color">
            Last Name
          </label>
          <input
            type="text"
        ...
        <div className="form-group">
          ...
          <input
            ...
            value={
              new Date(initProfile.dateOfBirth).toISOString().split("T")[0]
            }
            className="form-control"
          />
        </div>
