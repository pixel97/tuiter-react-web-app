    ...
    <>
      <div className="row">
        ...
        <div className="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10">
          <span style={{ color: "black", fontSize: "1.5em" }}>
      ...
      <div>
        ...
        <br />
        <span className="wd-gray-color">{profile.handle}</span>
        <br />
        <span className="wd-font-color">{profile.bio}</span>
        <br />
        <span className="wd-gray-color">
          <LocationOnIcon />
          {profile.location}&nbsp;
        </span>
        <span className="wd-gray-color">
