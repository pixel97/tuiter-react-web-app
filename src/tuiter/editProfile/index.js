...
const EditProfile = () => {
    ...
    return (<>
            ...
            <div className="row mt-1">
                <img src="/images/banner1.jpg" className="img-fluid" width="100%" height="200px" />
            </div>
            <img src="/images/ProfilePic1.jpg" className="wd-rounded-images position-relative" height="100px" width="100px" style={{"bottom":"1rem"}}/>
            <form>
