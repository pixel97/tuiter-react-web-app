        ...
        <ul class="list-group">
            <li class="list-group-item" style="background-color:black;">
                <div class = "row">
                    ...
                    <div class = "col-11">
                        <p style = "color:white; font-size:14px; font-weight:bold; margin-bottom:0;">${Items.userName}
                        ...
                        <p>${Items.title} <span style = "color:blue">${Items.link}</span></p>
                        <img src=${Items.image} style = "height:70%;width:100%; border-radius:3%";>
                        <p style="margin-bottom:0;">${Items.captiontitle}</p>
                        <p style = "color:gray; font-size:15px; margin-bottom : 0;">${Items.caption}</p>
